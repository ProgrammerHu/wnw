package com.hemaapp.luna_framework.util;
...
public class ImageTask extends XtomImageTask {
    ...
    public ImageTask(ImageView imageView, URL url, Object context, int beforeImage, Size size) {
        this(imageView, url, context, beforeImage);
        this.mSize = size;
    }

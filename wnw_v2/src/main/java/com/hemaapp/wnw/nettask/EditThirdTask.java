 ...
 */
public class EditThirdTask extends MyNetTask {
    public EditThirdTask(MyHttpInformation information, HashMap<String, String> params) {
    ...
    private class Result extends HemaArrayResult<String> {
        ...
        public String parse(JSONObject jsonObject) throws DataParseException {
            try {
                return jsonObject.getString("inviter_code");

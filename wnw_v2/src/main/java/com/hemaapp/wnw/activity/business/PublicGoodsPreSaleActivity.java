 ...
 */
public class PublicGoodsPreSaleActivity extends SelectImageEditActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_public_goods_pre_sale);

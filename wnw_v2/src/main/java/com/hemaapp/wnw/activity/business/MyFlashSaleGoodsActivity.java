 ...
 */
public class MyFlashSaleGoodsActivity extends MyActivity implements View.OnClickListener, MyGoodsListAdapter.OnEditListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        page = 0;
        getNetWorker().merchantGoodsList(getApplicationContext().getUser().getToken(), "3", "", "", String.valueOf(page));
    }
    ...
    protected void findView() {
        ...
        adapter = new MyGoodsListAdapter(mContext, listData, "3");
        adapter.setEmptyString("您还没有抢购商品");

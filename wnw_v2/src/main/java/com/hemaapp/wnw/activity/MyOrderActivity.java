 ...
 */
public class MyOrderActivity extends MyFragmentActivity implements View.OnClickListener {
...
//        viewPager.setPageTransformer(true, new StackTransformer());
    ...
    protected void findView() {
        ...
        adapter = new MyOrderPagerAdapter(getSupportFragmentManager(), IsGroup, false);

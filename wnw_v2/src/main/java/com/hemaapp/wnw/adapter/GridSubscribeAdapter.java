 ...
 */
public class GridSubscribeAdapter extends MyAdapter implements View.OnClickListener {
    ...
    public GridSubscribeAdapter(Context mContext, XtomGridView gridView, List<SubscribeList> listData, SubscribeFragment fragment) {
        super(mContext);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.griditem_subscribe, null);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.imageView:
                fragment.gotoSellerDetail(id);
                break;
            case R.id.imageDelete:
                fragment.removeSubscribe(id);
                break;
        }

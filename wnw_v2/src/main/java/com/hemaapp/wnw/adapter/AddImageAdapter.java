...
import com.hemaapp.wnw.activity.SelectImageActivity;
 ...
 */
public class AddImageAdapter extends MyAdapter implements View.OnClickListener {
    ...
    public AddImageAdapter(Context mContext, View rootView, ArrayList<String> images) {
        super(mContext);
        this.rootView = rootView;
        this.images = images;
        activity = (SelectImageActivity) mContext;
        ImageWidth = (MyUtil.getScreenWidth(mContext) - MyUtil.dip2px(mContext, 5) * 4
    ...
    private ArrayList<Image> getImages() {
        ...
        for (String image : this.images) {
            imageList.add(new Image(String.valueOf(i), String.valueOf(i), String.valueOf(i + 1), "", image, image, String.valueOf(i)));
            i++;
        }
        return imageList;
    }

...
public class PhotoPagerAdapter extends PagerAdapter {
    ...
    public PhotoPagerAdapter(MyActivity context, ArrayList<String> urllist) {
    ...
    public View instantiateItem(ViewGroup container, int position) {
        View view = LayoutInflater.from(context).inflate(
                R.layout.griditem_showlargepic_my, null);
        ...
        photoView.setOnViewTapListener(new PhotoViewAttacher.OnViewTapListener() {
            ...
            public void onViewTap(View view, float x, float y) {
                MyShowLargePicActivity a = (MyShowLargePicActivity) context;
                a.toogleInfo();
            }
        });
        ...
        try {
            if (MyConfig.DEBUG) {
                Log.e("PhotoPagerAdapter", imgPath);
            }
            ...
            int height = XtomWindowSize.getHeight(context);
            context.imageWorker.loadImage(new ImageTask(photoView, imgPath,
                    context, new Size(width, height), photoView, progressBar));
